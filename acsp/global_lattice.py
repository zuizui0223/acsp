...
Ported without changing the research lattice mechanics; contains no taxon or occurrence input. It
...
from .global_inputs import CountryLandGeometry, _parse_land_geometry
