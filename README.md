...
For widespread taxa, the app no longer mixes nationwide sites into one trip. Region recommendations use compact approximately 40 km-radius hubs. The default proposal assumes a two-day field mission beginning and ending at the selected hub, a 35 km/h average road speed, a 1.35 road-distance factor, 90 survey minutes and 20 access minutes per cell, and eight field hours per day. Candidate count is reduced when eight cells do not fit those assumptions. These are transparent planning defaults, not a road-routing guarantee.
