...
The relationship between ACSP and the separate `zuizui0223/eog` structural framework, the division of scientific labour between the two projects, and the order of the remaining work are fixed in [docs/ACSP_EOG_PROGRAM_STRATEGY.md](docs/ACSP_EOG_PROGRAM_STRATEGY.md).
